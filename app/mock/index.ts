export const faqs = [
  ...
  {
    que: "What can i watch no Netflix ?",
...
export const profiles = [
  { name: "Jackie", href: "/dashboard", img: "/images/profile_1.png" },
  { name: "Mania", href: "/dashboard", img: "/images/profile_2.png" },
  { name: "Andee", href: "/dashboard", img: "/images/profile_3.png" },
  { name: "Tyson", href: "/dashboard", img: "/images/profile_4.png" },
];

export const navItems = [
  { route: "Home", href: "/home" },
  { route: "Series", href: "/series" },
  { route: "Films", href: "/films" },
  { route: "New & Popular", href: "/popular" },
  { route: "My List", href: "/list" },
  { route: "Browse by languages", href: "/language" },
];
